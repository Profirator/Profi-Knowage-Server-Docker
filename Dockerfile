...
RUN wget -q -O "${LIB_COMMONS_LOGGING_NAME}" "${LIB_COMMONS_LOGGING_URL}"
RUN wget -q -O "${LIB_COMMONS_LOGGING_API_NAME}" "${LIB_COMMONS_LOGGING_API_URL}"
RUN wget -q -O "${LIB_CONCURRENT_NAME}" "${LIB_CONCURRENT_URL}"
RUN wget -q -O "${LIB_MYSQL_CONNECTOR_NAME}" "${LIB_MYSQL_CONNECTOR_URL}"
RUN wget -q -O "${LIB_GERONIMO_COMMONJ_NAME}" "${LIB_GERONIMO_COMMONJ_URL}"
RUN wget -q -O "${LIB_MYFOO_COMMONJ_NAME}" "${LIB_MYFOO_COMMONJ_URL}"
RUN wget -q -O "${LIB_POSTGRESQL_CONNECTOR_NAME}" "${LIB_POSTGRESQL_CONNECTOR_URL}"
